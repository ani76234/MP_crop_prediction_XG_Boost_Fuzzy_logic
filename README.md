...
#Note: GRID dataset containing the 1.6 million latitude and longitude points used for RPI cannot be uploaded as the files are over 500 MB. Pl refer to final output and Portfolio to understand working. All code files uploaded.
